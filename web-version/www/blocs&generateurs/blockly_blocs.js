...
Blockly.Blocks['ardublock_block']={init:function(){
    this.appendDummyInput()
       // .appendField(new Blockly.FieldImage("media/icon_block/001.png", 15, 15, null))
        ...
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.nano1_control_0, "0"],[Blockly.Msg.nano1_control_1, "1"],[Blockly.Msg.nano1_control_3, "3"], [Blockly.Msg.nano1_control_4, "4"],[Blockly.Msg.nano1_control_9, "9"], [Blockly.Msg.nano1_control_10, "10"]]), "deistvie")
...
Blockly.Blocks['ardublock_block1']={init:function(){
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.nano1_control_19, "5"],[Blockly.Msg.nano1_control_21, "6"], [Blockly.Msg.nano1_control_22, "3"], [Blockly.Msg.nano1_control_23, "4"], [Blockly.Msg.nano1_control_24, "7"]]), "deistvie")
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.nano1_control_13, "1"], [Blockly.Msg.nano1_control_14, "2"]]), "delay")
...
Blockly.Blocks['bt_key_print']={init:function(){
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldTextInput("RoboBlock EN"), "_text");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks['ps2x_block']={init:function(){
    this.appendDummyInput()
        .appendField("PS2")
        .appendField(new Blockly.FieldDropdown([["PSB_START", "PSB_START"],["PSB_SELECT", "PSB_SELECT"],["PSB_PAD_UP", "PSB_PAD_UP"],["PSB_PAD_RIGHT", "PSB_PAD_RIGHT"],["PSB_PAD_LEFT", "PSB_PAD_LEFT"],["PSB_PAD_DOWN", "PSB_PAD_DOWN"],["PSB_L3", "PSB_L3"],["PSB_R3", "PSB_R3"],["PSB_L2", "PSB_L2"],["PSB_R2", "PSB_R2"],["PSB_GREEN", "PSB_GREEN"],["PSB_RED", "PSB_RED"],["PSB_PINK", "PSB_PINK"],["PSB_BLUE", "PSB_BLUE"],["PSB_L1", "PSB_L1"],["PSB_R1", "PSB_R1"]]), "PS2xxs");
    this.appendStatementInput("PS2x")
        .setCheck("Number");
    this.setInputsInline(false);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks['text_int']={init:function(){
    this.appendValueInput("string-int-block")
        .appendField(Blockly.Msg.Stiin);
    this.setInputsInline(false);
    this.setOutput(true);
...
Blockly.Blocks['ar_vl53l0']={init:function(){
    this.appendDummyInput()
        .appendField("VL53L0");
    this.setInputsInline(true);
    this.setOutput(true);
    this.setColour("#6D7497");
    this.setTooltip('VIN - A3, GND - GND, SCL - A5, SDA - A4');
    //this.setHelpUrl('https://ardublock.ru/wiki')
	}
};
...
Blockly.Blocks['ar_GY-906']={init:function(){
    this.appendDummyInput()
        .appendField("GY-906");
    this.setInputsInline(true);
    this.setOutput(true);
    this.setColour("#6D7497");
    this.setTooltip('VIN - 3.3v, GND - GND, SCL - A5, SDA - A4');
    //this.setHelpUrl('https://ardublock.ru/wiki')
	}
};

 
 Blockly.Blocks['at_arduino_tex']={init:function(){
    this.appendStatementInput("at_statement")
        .appendField("AT");
    this.setInputsInline(false);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks['at_arduino_tex_box']={init:function(){
    this.appendDummyInput()
        .appendField("AT")
        .appendField(new Blockly.FieldTextInput("Bt01=1"), "bt_text");
    this.setInputsInline(false);
    this.setOutput(true);
    this.setColour("#0060aa");
   // this.setTooltip('help Vitaliy...');
...
Blockly.Blocks['at_arduino_tex_pn']={init:function(){
    this.appendValueInput("at_block")
        .setCheck("String")
        .setAlign(Blockly.ALIGN_CENTRE)
        .appendField("AT")
        .appendField(new Blockly.FieldTextInput("pl/bt.1.txt"), "bt_text");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour("#0060aa");
