var MSG = {
  ...
  btn_fakeload: "Добавить в проект",
  btn_fakeload2: "Открыть проект",
  btn_example: "Примеры",
  btn_term: "Монитор порта",
  btn_factory: "Wiki - Учебник",
  btn_saveXML: "Сохранить проект",
  btn_print: "Скриншот .png",
  ...
  exampleModalLabel: "Дата релиза: 05.05.2025",
  ...
  labelToolboxDefinition: "Платформа блочного кодирования для платформ Arduino и ESP",
  ...
  badXml: "Ошибка синтаксического анализа XML: \ n% 1 \ n \ n Выберите «ОК», чтобы отменить изменения, или «Отмена», чтобы продолжить редактирование XML.",
  arduino_card: "Загрузить настройки для платы(контроллера) ",
  aboutModalLabel: "Помощь",
  aboutBody: " ",
  nanoWarning: "Возникли проблемы при загрузке на плату (истекло время загрузки)? Попробуйте выбрать другой вариант платы (Обычный / Старый загрузчик / Общий), в зависимости от того, какая у вас плата. Некоторые платы визуально одинаковые (со старым и новым загрузчиком)!"
};

//'use strict';
//goog.provide ( 'Blockly.Msg.fr');
//goog.require ( 'Blockly.Msg');
Blockly.Msg.CAT_pro = "Разработчик";

Blockly.Msg.ESPBOY = "ESPboy";
Blockly.Msg.Start_ESP_Boy = "Запуск ESPboy";
Blockly.Msg.TonePin22 = "Звук Гц";
Blockly.Msg.espboy_button = "Кнопка";
Blockly.Msg.espboy_rgb = "Светодиод";
Blockly.Msg.espboy_text = "Печать";
Blockly.Msg.espboy_color = "Пиксель  X";
Blockly.Msg.espboy_line = "Линия  X";
Blockly.Msg.espboy_box = "Прямоугольник  X";
Blockly.Msg.backgroundcolor = "Цвет фона ";

Blockly.Msg.Stiin = "Число <= Текст";
Blockly.Msg.St = "Символ <= Текст";

Blockly.Msg.otto1 = "Дройд - Подключение";
Blockly.Msg.otto2 = "Зуммер";
Blockly.Msg.otto3 = "Дройд - Калибровка робота";
Blockly.Msg.otto4 = "Дройд - Движение";
Blockly.Msg.otto5 = "Идти вперёд";
Blockly.Msg.otto6 = "Идти назад";
Blockly.Msg.otto7 = "Разворот на лево";
Blockly.Msg.otto8 = "Разворот на право";
Blockly.Msg.otto9 = "Наклон на право";
Blockly.Msg.otto10 = "Наклон на лево";
Blockly.Msg.otto11 = "Понять левую ногу";
Blockly.Msg.otto12 = "Поднять правую ногу";
Blockly.Msg.otto13 = "Подняться";
Blockly.Msg.otto14 = "Нормально";
Blockly.Msg.otto15 = "Медленно";
Blockly.Msg.otto16 = "Очень медленно";
Blockly.Msg.otto17 = "Быстро";
Blockly.Msg.otto18 = "Очень быстро";
Blockly.Msg.otto19 = "Турбо быстро";
Blockly.Msg.otto20 = "Средний";
Blockly.Msg.otto21 = "Маленький";
Blockly.Msg.otto22 = "Большой";
Blockly.Msg.otto23 = "Качаться";
Blockly.Msg.otto24 = "Прыгать";
Blockly.Msg.otto25 = "Перекатываться";
Blockly.Msg.otto26 = "Дрожать";
Blockly.Msg.otto27 = "Восхищаться";
Blockly.Msg.otto28 = "Дройд - Перемещение";
Blockly.Msg.otto29 = "Скорость";
Blockly.Msg.otto30 = "Шаг";
Blockly.Msg.otto31 = "Скорость";
Blockly.Msg.otto32 = "Дройд - Действия";
Blockly.Msg.otto33 = "Дройд - Звук";
Blockly.Msg.otto34 = "Счастье";
Blockly.Msg.otto35 = "Весёлый";
Blockly.Msg.otto36 = "Смеётся";
Blockly.Msg.otto37 = "Грустный";
Blockly.Msg.otto38 = "Запутался";
Blockly.Msg.otto39 = "Ого";
Blockly.Msg.otto40 = "Ох";
Blockly.Msg.otto41 = "Неожиданно";
Blockly.Msg.otto42 = "Подключился";
Blockly.Msg.otto43 = "Отключился";

Blockly.Msg.nrf24l1l = "Канал";
Blockly.Msg.nrf24l2l = "Скорость";
Blockly.Msg.nrf24l3l = "Мощность";
Blockly.Msg.nrf24l4l = "Шифрование";


Blockly.Msg.PIANOO = "Пианино";
Blockly.Msg.PIANOO_pin = "Касание";

Blockly.Msg.uploadcom = "Ошибка платы!";
Blockly.Msg.comerror = "Ошибка в программе!";

Blockly.Msg.nano1_control = "Моторы";
Blockly.Msg.nano1_sensors = "Cенсоры";
Blockly.Msg.nano1_Systemic = "Системные";

Blockly.Msg.nano1_control_0 = "Калибровка";
Blockly.Msg.nano1_control_1 = "Лежать";
Blockly.Msg.nano1_control_2 = "Подняться";
Blockly.Msg.nano1_control_3 = "Наклон вперёд";
Blockly.Msg.nano1_control_4 = "Наклон назад";
Blockly.Msg.nano1_control_5 = "Узко Лежать";
Blockly.Msg.nano1_control_6 = "Узко Подняться";
Blockly.Msg.nano1_control_7 = "Узко Наклон вперёд";
Blockly.Msg.nano1_control_8 = "Узко Наклон назад";
Blockly.Msg.nano1_control_9 = "Скручение лево";
Blockly.Msg.nano1_control_10 = "Скручение право";
Blockly.Msg.nano1_control_11 = "Указ правой";
Blockly.Msg.nano1_control_12 = "Указ левой";
Blockly.Msg.nano1_control_13 = "Быстро";
Blockly.Msg.nano1_control_14 = "Медленно";

Blockly.Msg.nano1_control_15 = "Паук - Действие";
Blockly.Msg.nano1_control_16 = "Паук - Движение";
Blockly.Msg.nano1_control_17 = "Раз";
Blockly.Msg.nano1_control_18 = "Вперёд ползти";
Blockly.Msg.nano1_control_19 = "Вперёд бежать";
Blockly.Msg.nano1_control_20 = "Назад ползти";
Blockly.Msg.nano1_control_21 = "Назад бежать";
Blockly.Msg.nano1_control_22 = "Налево разворот";
Blockly.Msg.nano1_control_23 = "Направо разворот";
Blockly.Msg.nano1_control_24 = "Покачивание - НЕТ";

Blockly.Msg.nano1_control_25 = "Глаза робота, если меньше ";
Blockly.Msg.nano1_control_26 = "см. то";
Blockly.Msg.nano1_control_27 = "TRIG - 12, ECHO - 11  Данные с датчика оправляются в монитор порта! Если значение будет меньше указанного то выполнится функция!";

Blockly.Msg.nano1_control_28 = "Сервопривод";
Blockly.Msg.nano1_control_29 = "Положение";
Blockly.Msg.nano1_control_30 = "Скорость";
Blockly.Msg.nano1_control_31 = "Ждать";
Blockly.Msg.nano1_control_32 = "миллисекунд";

Blockly.Msg.nano1_control_33 = "Кнопка Reset - Вкл / Откл";
Blockly.Msg.nano1_sensors2 = "Управление";

Blockly.Msg.nano1_control_34 = "Светодиод на плате";
Blockly.Msg.nano1_control_35 = "Вкл";
Blockly.Msg.nano1_control_36 = "Откл";
Blockly.Msg.nano1_control_37 = "Манипулятор - Захват";
Blockly.Msg.nano1_control_38 = "Открыть";
Blockly.Msg.nano1_control_39 = "Прикрыть";
Blockly.Msg.nano1_control_40 = "Закрыть";
Blockly.Msg.nano1_control_41 = "Подключение сервомотора: 7 pin";
Blockly.Msg.nano1_control_42 = "Манипулятор - Поворотная платформа";
Blockly.Msg.nano1_control_43 = "Подключение сервомотора: Pin 3";
Blockly.Msg.nano1_control_44 = "Кнопка";
Blockly.Msg.nano1_control_45 = "С фиксацией ";
Blockly.Msg.nano1_control_46 = "Без фиксации";
Blockly.Msg.nano1_control_47 = "Подключение: Pin 2";
Blockly.Msg.nano1_control_48 = "Джойстик";
Blockly.Msg.nano1_control_49 = "Подключение: X - A0, Y - A1";
Blockly.Msg.nano1_control_50 = "Манипулятор - Положение";
Blockly.Msg.nano1_control_51 = "Калибровочное";
Blockly.Msg.nano1_control_52 = "Низ";
Blockly.Msg.nano1_control_53 = "Низ захват";
Blockly.Msg.nano1_control_54 = "Отогнуться";
Blockly.Msg.nano1_control_55 = "Предподнять";
Blockly.Msg.nano1_control_56 = "Поднять";
Blockly.Msg.nano1_control_57 = "Скорость";
Blockly.Msg.nano1_control_58 = "Быстро";
Blockly.Msg.nano1_control_59 = "Медленно";

Blockly.Msg.nano1_control_60 = "Подключение 3 сервомоторов: Pin 4, 5, 6";
...
Blockly.Msg.menuesp1 = "Светодиоды"; 
Blockly.Msg.menuesp2 = "Кнопка"; 
Blockly.Msg.menuesp3 = "Зуммер"; 
Blockly.Msg.menuesp4 = "Моторы"; 
Blockly.Msg.menuesp5 = "Сенсоры"; 
Blockly.Msg.menuesp6 = "Дисплей"; 
Blockly.Msg.menuesp7 = "Основные"; 


Blockly.Msg.bt_key = "BLE контроллер";
Blockly.Msg.bt_key1 = "BLE контроллер - Печать текста";
Blockly.Msg.bt_key2 = "BLE контроллер - Модификатор";
Blockly.Msg.bt_key3 = "BLE контроллер - Нажать";
Blockly.Msg.bt_key4 = "BLE контроллер - Отпустить клавиши";
Blockly.Msg.bt_key5 = "BLE контроллер - Задержка между кликами";

Blockly.Msg.bt_key6 = "BLE контроллер - Клик мыши";
Blockly.Msg.bt_key7 = "BLE контроллер - Колесо мыши";
Blockly.Msg.bt_key8 = "BLE контроллер - Курсор мыши";
Blockly.Msg.bt_key9 = "на";
Blockly.Msg.bt_key10 = "px";



Blockly.Msg.TonePin23 = "Зуммер -";
Blockly.Msg.TonePin24 = "Зуммер - Отключить";
Blockly.Msg.TonePin25 = "Зуммер - Нота";

Blockly.Msg.text_char32 = "Монитор порта";


Blockly.Msg.LCD_lcdi2c_print_gr232 = "Графика. Бл. Ст.";
Blockly.Msg.ARDUINO_INOUT_motoresp = "Мотор PWM - Pin";
Blockly.Msg.potenwiometre = "Потенциометр - Pin";
 
Blockly.Msg.DWIN_BOX = "Дисплей DWIN";
Blockly.Msg.Dwin_box = "DWIN - Box - Подключение";
Blockly.Msg.Dwin_box_DWIN_SET = "Перед использованием блоков, загрузите прошивку DWIN_SET в дисплей!";
...
Blockly.Msg.dwinledonof="UART Дисплей - Яркость подсветки";
Blockly.Msg.dwinreset="UART Дисплей - Перезагрузка";



Blockly.Msg.espled1 = "Светодиод";
Blockly.Msg.espled2 = "Вкл";
Blockly.Msg.espled3 = "Откл";
Blockly.Msg.espled4 = "RGB светодиод на плате";
Blockly.Msg.espled5 = "Адресная лента ";
Blockly.Msg.espled6 = "Включить";
Blockly.Msg.espled7 = "Перемещение →";
Blockly.Msg.espled8 = "Перемещение  ←";
Blockly.Msg.espled9 = "Набор →";
Blockly.Msg.espled10 = "Набор ←";
Blockly.Msg.espled11 = "Наполнение →";
Blockly.Msg.espled12 = "Наполнение ←";

Blockly.Msg.espMap1 = "Карта ";
Blockly.Msg.espMap2 = "от";
Blockly.Msg.espMap3 = "до";
Blockly.Msg.espMap4 = " от";
Blockly.Msg.espMap5 = "до";

Blockly.Msg.ARDUINO_INOUT_ledpwmesp32 = "Светодиод PWM";
...
//Blockly.Msg.HELPURL_093 = "site-help/093-ru.html"; //просто сервомотор
 ...
 Blockly.Msg.HELPURL_101 = "site-help/101-ru.html";  
 Blockly.Msg.HELPURL_102 = "site-help/102-ru.html";  
 Blockly.Msg.HELPURL_103 = "site-help/103-ru.html"; 
 Blockly.Msg.HELPURL_104 = "site-help/104-ru.html"; 


Blockly.Msg.CAT_ACS712="Датчик тока ACS712 - Тип";
//sim 800
Blockly.Msg.CAT_SIM800="GSM - Подключение SIM800 RX";
Blockly.Msg.CAT_SIM800_send="GSM - Отправить СМС";
Blockly.Msg.CAT_SIM800_tell="на номер телефона";
Blockly.Msg.CAT_SIM800_tell_sms="GSM - Входящий СМС";
Blockly.Msg.CAT_SIM800_tell_sms_text="GSM - Текст СМС";

//GPS
Blockly.Msg.CAT_GPS="GPS / GSM";
Blockly.Msg.GPS_name = "";
Blockly.Msg.GPS_init = "GPS - Подключение GY-NEO6 MV2";
Blockly.Msg.GPS_TX="TX";
Blockly.Msg.GPS_RX="RX";
Blockly.Msg.GPS_readvalues = "GPS - Чтение данных с модуля";
Blockly.Msg.GPS_paramter = "GPS - Местоположение:";
Blockly.Msg.GPS_paramter3 = "GPS - ДатаВремя:";
Blockly.Msg.GPS_Latitude = "Широта";
Blockly.Msg.GPS_Longitude = "Долгота";
Blockly.Msg.GPS_Altitude_in_meters = "Высота в метрах";
Blockly.Msg.GPS_Course_in_degrees = "Курс в градусах";
Blockly.Msg.GPS_Number_of_satellites = "Количество спутников";
Blockly.Msg.GPS_name2 = "GPS - Скорость";
Blockly.Msg.GPS_Year = "Год";
Blockly.Msg.GPS_Month = "Месяц";
Blockly.Msg.GPS_Day = "День";
Blockly.Msg.GPS_Hours = "Час";
Blockly.Msg.GPS_Minutes = "Минуты";
Blockly.Msg.GPS_Seconds = "Секунды";
Blockly.Msg.x9c103s = "Цифровой потенциометр X9C103S - CS";
Blockly.Msg.x9c103sval = "Значение";

Blockly.Msg.bizersope = "Зуммер - Отключить Pin";

Blockly.Msg.base_define_ttl_uart_top_nom_var_g = "в график ";
Blockly.Msg.ARDUINO_INOUTkanal = "Канал";
Blockly.Msg.ARDUINO_INOUTgc = "Частота";
Blockly.Msg.ARDUINO_INOUTbit = "Бит";
Blockly.Msg.ARDUINO_INOUThelpb = "На pin один канал 0 - 15, Частота 5000 - 10 000 Гц, Скорость 1 - 16 бит";
Blockly.Msg.Hardware_monitor = "Hardware monitor - Чтение!";
Blockly.Msg.TEXT_LENGTH_TITLEru = "RU";
Blockly.Msg.ESP_deepsleep = "Глубокий сон ";
Blockly.Msg.ESP_timesleep = "";
// Electron window
Blockly.Msg.CAT_WS2812B = "Адресная лента";
Blockly.Msg.com1 = "Выберите порт USB ";
Blockly.Msg.com2 = "Ошибка USB порта" ;
Blockly.Msg.check = "Проверка...";
Blockly.Msg.upload = "Загрузка...";
Blockly.Msg.error = "Ошибка в программе!";
...
Blockly.Msg.CAT_ARDUINO_IN2 = "Выходы";
...
Blockly.Msg.init_temp_ds18b20_1="DS18B20 - Сканер адресов Pin";
Blockly.Msg.init_temp_ds18b20_2="DS18B20 - Подключение Pin";
Blockly.Msg.init_temp_ds18b20_3="Сенсор";
Blockly.Msg.init_temp_ds18b20_4="Адрес"; 
Blockly.Msg.init_temp_ds18b20_5="DS18B20 - Чтение Pin";
 
 
Blockly.Msg.pin_botton_pro="GND - Pin";
Blockly.Msg.pin_botton_pro3="+5V - Pin";
Blockly.Msg.pin_botton_Mode="Режим";
Blockly.Msg.pin_botton_Latched="С фиксацией";
Blockly.Msg.pin_botton_NLatched="Без фиксации";

 
Blockly.Msg.dwinledonof="UART Дисплей - Яркость подсветки";
Blockly.Msg.dwinreset="UART Дисплей - Перезагрузка";
Blockly.Msg.CAT_INDIKATORI2="Матрицы LED";
Blockly.Msg.CAT_DISPLAYU_ROBO="Роботы";
//lcd bottom
Blockly.Msg.lcd_bottom="LCD 16x2 - Кнопка";
...
Blockly.Msg.CAT_SENSORDRUGIE = "Программы";
Blockly.Msg.CAT_SENSORRECORD = "Аудио модули";
Blockly.Msg.CAT_INDIKATORI = "Индикаторы";
Blockly.Msg.CAT_DISPLAYU = "Дисплей LCD";
Blockly.Msg.CAT_TFTDISPLAYU = "TFT Дисплей";
Blockly.Msg.CAT_LEONARDO1 = "Клавиатура";
Blockly.Msg.CAT_LEONARDO2 = "Мышь";
...
Blockly.Msg.SERVO_Servo = "Расширитель портов PCA 9685 - Адрес"; 
Blockly.Msg.PIN = "Сервопривод"; 
Blockly.Msg.Degree = "Угол";

Blockly.Msg.l9110MOTOR_D = "Мотор - L298P - RM HN";
...
Blockly.Msg.l9110MOTOR_L = "Мотор - L293D - N1 (pwm)";
...
Blockly.Msg.STEEPER_name4945 = "Шаговый мотор - A4988 - DIR";
...
Blockly.Msg.ultrasonic_ranger="Дальномер HC-SR04 - Trig - Pin";
Blockly.Msg.TRIG="";
Blockly.Msg.Echo="Echo - Pin";

Blockly.Msg.DHT_NAME="Модуль DHT - Pin";
...
Blockly.Msg.MCP23017="Расширитель портов MCP23017 - Pin";

Blockly.Msg.RE_Interrupt="Энкодер - Pin";
...
Blockly.Msg.hall_read = "Датчик холла - ESP 32";
...
Blockly.Msg.LedRGBName = "Светодиод RGB - Общий";
...
Blockly.Msg.ledstrip_WS2812B_nameR = "Адресная лента WS2812 - Пикселей";
...
Blockly.Msg.KEYPAD_NAME = "Клавиатура 4х3 4х4 - Pin";
...
Blockly.Msg.MAX7219_LM_PAINT_x = "8 x 8 MAX7219 - Пиксель X -";
Blockly.Msg.MAX7219_LM_PAINT_y = "Y -";
Blockly.Msg.MAX7219_LM_PAINT_px = "Сигнал -";

Blockly.Msg.MAX7219_LM_NAMEB44 = "8 x 8 MAX7219 - Подключение";
Blockly.Msg.MAX7219_LM_NAMEB45 = "8 x 8 MAX7219 - Текст";

Blockly.Msg.РС74HC595 = "Сдвиговый регистр 74HC595 - №";
...
Blockly.Msg.CAT_LCDI2C = "Дисплей LCD";
Blockly.Msg.LCDP_setBcklight = "LCD 16x2 I2C - Подсветка";
Blockly.Msg.LCDP_Clear = "LCD 16x2 I2C - Очистить дисплей";
Blockly.Msg.LCD_I2C_setup = "LCD 16x2 I2C - Адрес";
...
Blockly.Msg.miniLCD_I2C_setuprotate = "Mini OLED 128x64 I2C - Положение";
Blockly.Msg.miniLCD_I2C_setupsds = "адрес";
...
Blockly.Msg.miniLCD_I2C_print_drawnone = "Mini OLED 128x64 I2C - Очистить дисплей!";
...
Blockly.Msg.CAT_OLED_U8G = "Дисплей OLED";
Blockly.Msg.CAT_DISPLAYU_LCDP = "Дисплей LCD 1";
...
Blockly.Msg.ST7735_name = "TFT ST7735 - Цвет фона";
Blockly.Msg.ST7735_IconName = "TFT ST7735 - Иконка";
Blockly.Msg.ST7735_ValueList = "Код";

Blockly.Msg.UART_Display = "Дисплей UART";
...
Blockly.Msg.lcd_tah_spi_tah = "TFT Touch 240x320 - Координаты";
...
Blockly.Msg.Telegram_Bot_w1 = "Telegram Bot - Пришло сообщение";
Blockly.Msg.Telegram_Bot_w2 = "Telegram Bot - Ответить на сообщение";
Blockly.Msg.Telegram_Bot_w3 = "Telegram Bot - Текст сообщения";
Blockly.Msg.Telegram_Bot_w4 = "Отправить сообщение";
Blockly.Msg.Telegram_Bot_w5 = "Telegram Bot - ID Chat";
Blockly.Msg.Telegram_Bot_w6 = "Telegram Bot - Отправить письмо";
Blockly.Msg.Telegram_Bot_w7 = "Telegram Bot - Имя отправителя";

Blockly.Msg.CAT_TFT_ST7735 = "Дисплей TFT";
...
Blockly.Msg.WifiServer_ESP8266webserver_port = "Веб-сервер Wifi ESP8266 Порт";
Blockly.Msg.WIFI_sta_init = "WIFI Подключиться как станции";
Blockly.Msg.WIFI_ap_init = "WIFI Создать точку доступа";
Blockly.Msg.WIFI_sta_ap_init = "WIFI Станция и создание точки доступа";
Blockly.Msg.WIFI_password = "пароль:";
Blockly.Msg.WIFI_ssid = "Wifi ssid:";
Blockly.Msg.WIFI_password_ap = "пароль:";
Blockly.Msg.WIFI_ssid_ap = "Wifi ssid имя:";
Blockly.Msg.WIFI_logs = "Включить журнал";
//IFTTT
Blockly.Msg.IFTTT_init = "Ключ конфигурации Api";
Blockly.Msg.IFTTT_send = "Отправить информацию";
Blockly.Msg.IFTTT_event = "Событие как строка";
Blockly.Msg.IFTTT_value1 = "Значение 1 ";
Blockly.Msg.IFTTT_value2 = "Значение 2 ";
Blockly.Msg.IFTTT_value3 = "Значение 3 ";
//MQTT
Blockly.Msg.MQTT_name_init = "Конфигурация MQTT протокол";
Blockly.Msg.MQTT_password = "пароль:";
Blockly.Msg.MQTT_ssid = "Wifi ssid:";
Blockly.Msg.MQTT_server = "Сервер (broker):";
Blockly.Msg.MQTT_port = "порт:";
Blockly.Msg.MQTT_user = "User:";
Blockly.Msg.MQTT_APIkey = "API Key:";
Blockly.Msg.MQTT_client = "ID клиент:";
Blockly.Msg.MQTT_topicattend = "Программа MQTT";
Blockly.Msg.MQTT_topicsubscribe = "Подписаться";
Blockly.Msg.MQTT_topicsubscribe2 = "сохранить числовое значение в переменной";
Blockly.Msg.MQTT_topicsubscribe3 = "сохранить текстовое значение в переменной";
Blockly.Msg.MQTT_topicpublish = "Опубликовать";
Blockly.Msg.MQTT_topicvalue = "Значение";
Blockly.Msg.MQTT_logs = "Включить журналы";
//Telegram
Blockly.Msg.Telegram_name_init = "Конфигурация Telegram-чата.";
Blockly.Msg.Telegram_name = "Telegram.";
Blockly.Msg.Telegram_BotToken = "BOT токен";
Blockly.Msg.Telegram_ChatID = "Чат ID";
Blockly.Msg.Telegram_Loop = "Telegram Обновление сообщений";
Blockly.Msg.Telegram_receive = "Telegram Когда сообщение получено";
Blockly.Msg.TelegramSend= "Отправить сообщение:";
Blockly.Msg.Telegram_message = "Telegram Получено сообщение";
Blockly.Msg.Telegram_fromName= "Имя пользователя";

//OpenWeather
Blockly.Msg.Openweather_init = "Конфигурация Погоды.";
Blockly.Msg.Api_key = "Ключ API";
Blockly.Msg.ReadWeather = "OpenWeather.Читать погоду.";
Blockly.Msg.City = "Город";
Blockly.Msg.CountryCode = "Код страны";
Blockly.Msg.OW_Value = "Погода. Значение:";
Blockly.Msg.LocationOW = "Местоположение";
Blockly.Msg.Country = "Страна";
Blockly.Msg.Icon = "Значок";
Blockly.Msg.Weather = "Погода";
Blockly.Msg.Description = "Описание";
Blockly.Msg.OW_Temperature = "Температура ºC";
Blockly.Msg.Temp_max = "Максимальная температура ºC";
Blockly.Msg.Temp_min = "Мин. температура ºC";
Blockly.Msg.Humidity = "Humedad";
Blockly.Msg.Preassure = "Давление";
Blockly.Msg.Feels_like = "По ощущениям температура ºC";
Blockly.Msg.Cloud = "Облако %";
Blockly.Msg.Visibility = "Видимость %";
Blockly.Msg.wind_speed = "Скорость ветра";
Blockly.Msg.wind_angle = "Угол ветра";
Blockly.Msg.icon_id = "Значок погоды с идентификатором";
Blockly.Msg.sunrise = "Восход EPOC";
Blockly.Msg.sunset = "Закат EPOC";

 
//Wifi Server
Blockly.Msg.WifiServer_wait="Ждать подключения клиентов"
Blockly.Msg.WifiServer_port="Сервер Wi-Fi начинается в порту"
Blockly.Msg.WifiServer_answer="Ответ сервера Wi-Fi:"
Blockly.Msg.WifiServer_stop="Остановить подключение клиента к нашему серверу"
Blockly.Msg.WifiServer_flush="Сбросить подключенный клиент на наш сервер"
Blockly.Msg.WifiServer_ip="IP адрес подключенного клиента"
Blockly.Msg.WifiServer_request="Запрос подключенного клиента"
Blockly.Msg.WifiServer_ESP8266webserver_parameter="ESP8266 WebServer Чтение параметра: "
Blockly.Msg.WifiServer_ESP8266webserver_parameter2="Параметры веб-сервера ESP8266: "
Blockly.Msg.WifiServer_esp8266_send_html_URL = "Когда клиент с этим URL (пустым для root):";
Blockly.Msg.WifiServer_esp8266_send_html_HTML_page="подключен, затем показать эту HTML-страницу: ";
Blockly.Msg.WifiServer_esp8266_send_html_execute="(необязательно) и выполните: ";
Blockly.Msg.WifiServer_esp8266_manage_requets="Управление запросом клиента";
Blockly.Msg.Wifi_ap_fixip="Режим точки доступа.Статический IP"
Blockly.Msg.Wifi_sta_fixip="Режим станции.Статический IP"
Blockly.Msg.Wifi_ip="IP"
Blockly.Msg.Wifi_Mask="Маска"
Blockly.Msg.Wifi_Gateway="Шлюз"
//NTP
Blockly.Msg.NTP_NAME="NTP - Часовой пояс";
Blockly.Msg.NTP_NAME2="NTP - Данные";
Blockly.Msg.NTP_READ_RTC="NTP - Прочитать дату и время";
Blockly.Msg.NTP_GMT="GMT";
Blockly.Msg.NTP_VALUES="";
Blockly.Msg.NTP_EPOCH="Эпоха";
Blockly.Msg.NTP_DAY="День";
Blockly.Msg.NTP_MONTH="Месяц";
Blockly.Msg.NTP_YEAR="Год";
Blockly.Msg.NTP_HOUR="Час";
Blockly.Msg.NTP_MINUTE="Минута";
Blockly.Msg.NTP_SECOND="Секунда";
Blockly.Msg.NTP_DOFWEEK="День недели";
Blockly.Msg.NTP_TEXT_DOFWEEK="День недели";
Blockly.Msg.NTP_TEXT_MONTH="Месяц";
Blockly.Msg.NTP_TEXT_TIME="Время";
//Thingspeak
 
Blockly.Msg.TOUCH="Аналоговый - Вход TOUCH";
Blockly.Msg.TOUCH2=" < ";
 
Blockly.Msg.Thingspeak_name_init = "Конфигурация Thingspeak.";
Blockly.Msg.Thingspeak_name = "Thingspeak";
Blockly.Msg.Thingspeak_channel = "Канал";
Blockly.Msg.Thingspeak_apiread = "Ключ чтения API";
Blockly.Msg.Thingspeak_apiwrite = "Ключ записи API";
Blockly.Msg.Thingspeak_Write= "Записать значение";
Blockly.Msg.Thingspeak_field = "в поле";
Blockly.Msg.Thingspeak_ReadLong= "Читать до тех пор, пока поле";
Blockly.Msg.Thingspeak_ReadFloat= "Читать как плавающее поле";
...
Blockly.Msg.ARD_TYPE_CHAR = "char - 1 Символ ASCII - 1 байт";
Blockly.Msg.ARD_TYPE_TEXT = "String - Текст - 1 байт";
Blockly.Msg.ARD_TYPE_BOOL = "boolean - Логическая - 1 байт - 0 или 1, true или false";
Blockly.Msg.ARD_TYPE_SHORT = "byte - Целое число - 1 байт - от 0 до 255";
Blockly.Msg.ARD_TYPE_NUMBER = "int - Целое число - 2 байта - от -32 768 до 32 767";
Blockly.Msg.ARD_TYPE_LONG = "long - Целое число - 4 байта - от -2 147 483 648 до 2 147 483 647";
Blockly.Msg.ARD_TYPE_DECIMAL = "float - Десятичное число - 4 байта - от -3.4028235E+38 до 3.4028235E+38";
...
Blockly.Msg.ADD_COMMENT = "Комментарий";
Blockly.Msg.CHANGE_VALUE_TITLE = "Change value:";
Blockly.Msg.CLEAN_UP = "Упорядочить блоки";
Blockly.Msg.COLLAPSE_ALL = "Свернуть блок";
Blockly.Msg.COLLAPSE_BLOCK = "Свернуть блок";
Blockly.Msg.CONTROLS_SWITCH_VAR_TITLE = "Если ";
Blockly.Msg.CONTROLS_SWITCH_MSG_DEFAULT = "иначе";
Blockly.Msg.CONTROLS_SWITCH_MSG_CASEBREAK = "равна";
Blockly.Msg.CONTROLS_SWITCH_MSG_SWITCHVAR = "если";
Blockly.Msg.CONTROLS_SWITCH_MSG_DO = "прошло";
...
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "если не";
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = "повтор %1 время";
//Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Run statements multiple times";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "повтор up";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "повтор as long as";
...
Blockly.Msg.DELETE_ALL_BLOCKS = "Вы действительно хотите удалить все блоки?";
Blockly.Msg.DELETE_BLOCK = "Удалить блок";
Blockly.Msg.DELETE_VARIABLE = "Удалить переменную";
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION = "Вы действительно хотите удалить переменную %2 ?";
Blockly.Msg.DELETE_X_BLOCKS = "Удалить блоки";
Blockly.Msg.DISABLE_BLOCK = "Отключить блок";
Blockly.Msg.DUPLICATE_BLOCK = "Дублировать";
Blockly.Msg.ENABLE_BLOCK = "Включить блок";
Blockly.Msg.EXPAND_ALL = "Развернуть блок";
Blockly.Msg.EXPAND_BLOCK = "Развернуть блок";
Blockly.Msg.EXTERNAL_INPUTS = "Блок в ромбик";
Blockly.Msg.HELP = "Информация";
Blockly.Msg.INLINE_INPUTS = "Блок в строку";
...
Blockly.Msg.MATH_RANDOM_INT_TITLE = "Случайное число - От %1 до %2";
Blockly.Msg.MATH_RANDOM_INT_TITLE_map = "Карта - Значение %1 от %2 до %3 преобразовать от %4 до %5";
...
Blockly.Msg.NEW_VARIABLE_TITLE = "Название новой переменной:";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "Функция";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING = "Внимание: эта функция имеет повторяющиеся переменные.";
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "Найти функцию";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TYPE = "Тип";
//Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP = "Add an entry to the procedure or function";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "Аргумент";
//Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP = "Add, delete, or rearrange";
Blockly.Msg.REDO = "Вернуть действие";
Blockly.Msg.REMOVE_COMMENT = "Удалить комментарий";
Blockly.Msg.RENAME_VARIABLE = "Переменовать переменную";
Blockly.Msg.RENAME_VARIABLE_TITLE = "Изменить название переменной '%1'";
//Array
Blockly.Msg.ARRAY_CREATE_EMPTY_TITLE = 'empty!';
Blockly.Msg.tab_create = "Создать блок %1 ";
Blockly.Msg.tab_create_fix = "Создать блок запись в массив %1";
Blockly.Msg.ARRAY_CREATE_WITH = "made up of";
Blockly.Msg.ARRAY_taille = "size";
Blockly.Msg.ARRAY_contenu = "which contains";
Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TITLE_ADD = "Элементы";
//Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TOOLTIP = "Add, Delete, or Reorder";
Blockly.Msg.ARRAY_CREATE_WITH_INPUT_WITH = "Элемент";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TITLE = "Блок";
//Blockly.Msg.ARRAY_CREATE_WITH_TOOLTIP = "Returns a list with a number of items";
Blockly.Msg.ARRAY_GETINDEX_ITEM = "Массив";
...
Blockly.Msg.ARRAY_create = "Объявить массив";
Blockly.Msg.ARRAY_fixe = "Запись в";
Blockly.Msg.ARRAY_dim = "размер";
Blockly.Msg.ARRAY_index = "Чтение из";
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "Блок";
//Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Add, Delete, or Reorder";
Blockly.Msg.TEXT_ISEMPTY_TITLE = "Проверка наличии текста";
...
Blockly.Msg.TEXT_LENGTH_TITLE = "Кол-во символов %1";
...
Blockly.Msg.UNDO = "Отменить действие";
Blockly.Msg.VARIABLES_AS = "тип";
Blockly.Msg.VARIABLES_DEFAULT_NAME = "Текст";
Blockly.Msg.VARIABLES_GET_CREATE_SET = "Создать блок переменной %1'";
//Blockly.Msg.VARIABLES_GET_TOOLTIP = "returns the value of this variable";
Blockly.Msg.VARIABLES_SET = "Присвоить";
...
Blockly.Msg.CONTROLS_IF_MSG_THEN = "то";
